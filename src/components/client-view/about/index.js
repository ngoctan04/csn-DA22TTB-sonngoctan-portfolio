...
export default function ClientAboutView({ data }) {
  ...
  const aboutDataInfo = [
    { label: "Dự án học tập ", value: data?.noofclients || "0" },
    { label: "Kinh nghiệm học tập ", value: data?.noofprojects || "0" },
    { label: "Hoạt động ", value: data?.yearofexperience || "0" },
  ];

  const headingText = "Các công cụ hỗ trợ ";
            ...
            >
              <div className="flex m-0 w-40 sm:w-auto">
                <div className="flex flex-col">
                  <p className="text-[50px] text-green-main font-bold">{infoItem.value}+</p>
